...
def controlled_retraction(nanonis, initial_z_position, retract_distance=100e-9, retract_steps=10, original_bias=1.0):
    ...
    Args:
        ...
        original_bias: The bias voltage to restore after retraction (always 1.0V in this case).
    """
    ...
    # Step 4: Restore original bias voltage (kept at 1.0V) and feedback loop
    logging.info(f"Bias voltage remains at 1.0V.")
